  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active">
               <li><a href="table-admin.php">Admin Table</a></li>
              </li>
              <li>
                <li><a href="table-client.php">Users table</a></li>
              </li>
              <li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Admins Table</h3>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                <?PHP include "C:/wamp64/www/projet/core/adminC.php";
                $admin1C=new adminC();
                $listeadmin=$admin1C->afficher();

                ?>

                      <form method="POST" action="ajouterAdmin.php" method="post" id="contactForm" >									<div class="col-lg-12">
                        <input type="text" class="text-nowrap align-middle" id="nom" name="nom" placeholder="Name">
                        <input type="text" class="text-nowrap align-middle" id="email" name="email" placeholder="Email">
                        <input type="text" class="text-nowrap align-middle" id="mdp" name="mdp" placeholder="Password">
                         <input type="submit" name="ajouter" value="Add">
  
                      </form> 


                  <?PHP foreach($listeadmin as $row){ ?>
                     <tr>
                        <td class="text-nowrap align-middle"> <?PHP echo $row['id']; ?></td>
